...
public class CartItemListPage extends JPanel {
	...
	JTable cartTable;
	Object[] tableHeader = {"도서ID", "도서명", "단가", "수량", "총 가격"};
	...
	public CartItemListPage(JPanel panel, Cart cart) {
		...
		JLabel totalPricelabel = new JLabel("총 금액: " + totalPrice + " 원");
		...
		clearButton.addActionListener(new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				if(cart.mCartCount==0) {
					...
					int select = JOptionPane.showConfirmDialog(clearButton, "장바구니의 모든 항목을 삭제하시겠습니까?");
					if(select==0) {
